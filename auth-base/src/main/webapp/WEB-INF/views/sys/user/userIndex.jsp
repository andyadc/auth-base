...
<body>
	...
	<div id="content" class="row-fluid">
		...
		<div id="right">
			<iframe id="userContent" src="${adminCtx}/sys/user/list" width="100%" height="91%" frameborder="0"></iframe>
		</div>
	</div>
	...
	<script type="text/javascript">
		...
		var setting = {data:{simpleData:{enable:true,idKey:"id",pIdKey:"pId",rootPId:'0'}},
			callback:{onClick:function(event, treeId, treeNode){
					...
					//$('#userContent').attr("src","${ctx}/sys/office/list?id="+id+"&parentIds="+treeNode.pIds);
				}
			}
		};
		
		function refreshTree(){
			$.getJSON("${adminCtx}/sys/org/treeData",function(data){
