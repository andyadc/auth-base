...
<body>
	...
	<h1 class="form-signin-heading">邪乎到家必有鬼</h1>
	<form id="loginForm" class="form-signin" action="${ctx}${fns:getAdminPath()}/login" method="post">
		...
		<label for="rememberMe" title="下次不需要再登录" class="rememberMe">
			<input type="checkbox" id="rememberMe" name="rememberMe" class="middle"/> 
			<span class="middle">记住我（公共场所慎用）</span>
		</label>
		
	</form>
	<div class="footer">
		Copyright &copy; 2012-2015 
		<a href="${pageContext.request.contextPath}">Andyadc 快速开发平台</a>
		- Powered By 
