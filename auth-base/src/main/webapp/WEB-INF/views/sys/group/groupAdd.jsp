...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active">
			<a href="${ctx}${fns:getAdminPath()}/sys/group/add">用户组添加</a>
		</li>
	</ul>
	<br/>
	<form id="inputForm" action="save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<span><input id="isShow1" name="usable" class="required" type="radio" value="1" checked="checked"/><label for="isShow1">可用</label></span>
				<span><input id="isShow2" name="usable" class="required" type="radio" value="0"/><label for="isShow2">不可用</label></span>
			</div>
		</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<textarea name="remark" rows="3" maxlength="200" class="input-xlarge"></textarea>
			</div>
		</div>
