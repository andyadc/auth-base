...
import com.adc.idea.common.exception.FileNameLengthLimitExceededException;
import com.adc.idea.common.exception.InvalidExtensionException;
import com.adc.idea.common.utils.security.Coder;
...
public class FileUploadUtils {
	...
	/**
	 * 编码文件名,默认格式为： 1、'_'替换为 ' ' 2、hex(md5(filename + now nano time +
	 * counter++)) 3、[2]_原始文件名
	 *
	 * @param filename
	 * @return
